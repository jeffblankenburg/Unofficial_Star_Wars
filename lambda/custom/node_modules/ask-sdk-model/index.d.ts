...
export declare namespace interfaces.amazonpay.model.v1 {
    /**
     * Represents the address chosen by the buyer through the AddressBook widget. Complete buyer information is returned only after you have confirmed the billing agreement or have specified a valid AddressConsentToken in the GetBillingAgreementDetails operation. Until then, only the City, StateOrRegion, PostalCode, and CountryCode elements are returned.
     * @interface
     */
    interface Destination {
        'destinationType'?: string;
        'physicalDestination'?: interfaces.amazonpay.model.v1.Address;
    }
}
export declare namespace interfaces.amazonpay.model.v1 {
    /**
